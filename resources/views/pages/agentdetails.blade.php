...
@section('breadcrumb','Agent Details')
@section('content')
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="contact-details">
                                ...
                                <div class="contact-list">
                                    <ul>
                                        <li> <sapn><img src="{{ URL::asset('img/icon/phone.png') }}" alt=""></sapn> +1245  785  659 </li>
                                        <li> <sapn><img src="{{ URL::asset('img/icon/email.png') }}" alt=""></sapn> admin@gmail.com</li>
