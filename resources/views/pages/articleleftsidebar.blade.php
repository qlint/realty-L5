@extends('main2')
@section('title','Article Left Sidebar')
                                ...
                                <div class="recent-post-inner">
                                    <div class="single-recent-post fix">
                                        <div class="recent-post-thumbnail">
                                            <a href="article.php"><img src="{{ URL::asset('img/blog/r-1.jpg') }}" alt=""></a>
                                        </div>
                                    ...
                                    <div class="single-recent-post fix">
                                        <div class="recent-post-thumbnail">
                                            <a href="article.php"><img src="{{ URL::asset('img/blog/r-2.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="recent-post-desc">
                                            <div class="post-title">
                                    ...
                                    <div class="single-recent-post fix">
                                        <div class="recent-post-thumbnail">
                                            <a href="article.php"><img src="{{ URL::asset('img/blog/r-3.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="recent-post-desc">
                                            <div class="post-title">
                                ...
                                <div class="property-buying-guide">
                                    <div class="single-guide">
                                        <div class="guide-icon">
                                            <img src="{{ URL::asset('img/blog/g-1.png') }}" alt="">
                                        </div>
                            ...
                            <aside class="single-side-box discount">
                                <div class="discount-inner">
                                    <div class="discount-img">
                                        <img src="{{ URL::asset('img/blog/discount.jpg') }}" alt="">
                                    </div>
                    ...
                    <div class="col-md-8 col-sm-12 col-xs-12">
                        <article class="blog-details">
                            <div class="blog-thubmnail">
                                <a href="#">
                                    <img src="{{ URL::asset('img/blog/article.jpg') }}" alt="">
                                </a>
                                <div class="blog-post">
                                    <span class="post-day">
                                        20
                            ...
                            <div class="article-comment-box">
                                ...
                                <div class="single-comment-box fix">
                                    <div class="comment-thumbnail">
                                        <img src="{{ URL::asset('img/blog/comment-1.jpg') }}" alt="">
                                    </div>
                                ...
                                <div class="single-comment-box reply-comment fix">
                                    <div class="comment-thumbnail">
                                        <img src="{{ URL::asset('img/blog/comment-2.jpg') }}" alt="">
                                    </div>
                                    <div class="comment-desc">
                                        <div class="comment-name">
                                            <h6>Lora Smith</h6>
                                ...
                                <div class="single-comment-box fix">
                                    <div class="comment-thumbnail">
                                        <img src="{{ URL::asset('img/blog/comment-3.jpg') }}" alt="">
                                    </div>
                                    <div class="comment-desc">
                                        <div class="comment-name">
                                            <h6>Thomas Albert</h6>
