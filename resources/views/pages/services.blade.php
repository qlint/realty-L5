...
@section('content')
        ...
        <div class="welcome-haven services">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="welcome-haven-img fadeInLeft wow" data-wow-delay="0.2s">
                            <img src="{{ URL::asset('img/welcome/3.png') }}" alt="">
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12 col-xs-12 welcome-pd fadeInRight wow" data-wow-delay="0.2s">
                        <div class="welcome-title">
                            <h3 class="title-1"><span>WE PROVIDE</span> BEST SERVICES</h3>
                            <h4 class="title-2">FOR THAT REASON OUR CLIENTS <span>ALWAYS HAPPY</span></h4>
                        </div>
                        ...
                        <div class="welcome-services">
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-12 ">
                                    <div class="w-single-services">
                                        <div class="services-img">
                                            <img src="{{ URL::asset('img/welcome/icon-1.png') }}" alt="">
                                        </div>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 ">
                                    <div class="w-single-services">
                                        <div class="services-img">
                                            <img src="{{ URL::asset('img/welcome/icon-2.png') }}" alt="">
                                        </div>
                                        <div class="services-desc">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 ">
                                    <div class="w-single-services">
                                        <div class="services-img">
                                            <img src="{{ URL::asset('img/welcome/icon-3.png') }}" alt="">
                                        </div>
                                        <div class="services-desc">
                                            <h6>Easy to Find</h6>
                                            <p>Low cost provides yur best for <br> elit, sed do eiusmod tempe</p>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 ">
                                    <div class="w-single-services">
                                        <div class="services-img">
                                            <img src="{{ URL::asset('img/welcome/icon-4.png') }}" alt="">
                                        </div>
                                        <div class="services-desc">
                                            <h6>Reliable</h6>
                                            <p>Low cost provides yur best for <br> elit, sed do eiusmod tempe</p>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-4 col-sm-12">
                        <div class="single-services wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.2s">
                            <div class="single-services-img">
                                <img src="{{ URL::asset('img/service/1.png') }}" alt="">
                            </div>
                    ...
                    <div class="col-md-4 col-sm-4 col-sm-12">
                        <div class="single-services wow fadeInUp" data-wow-duration="1.4s" data-wow-delay="0.2s">
                            <div class="single-services-img">
                                <img src="{{ URL::asset('img/service/2.png') }}" alt="">
                            </div>
                            <div class="single-services-desc">
                                <h5>Sale Property</h5>
                                <p>Sidai Naivasha the best theme for  elit, sed do eiumod tempor dolor sit amet, conse ctetur adipiscing elit, sed do eiusmod tempor incididunt ut </p>
                    ...
                    <div class="col-md-4 col-sm-4 col-sm-12">
                        <div class="single-services wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0.4s">
                            <div class="single-services-img">
                                <img src="{{ URL::asset('img/service/3.png') }}" alt="">
                            </div>
                            <div class="single-services-desc">
                                <h5>rent Property</h5>
                                <p>Sidai Naivasha the best theme for  elit, sed do eiumod tempor dolor sit amet, conse ctetur adipiscing elit, sed do eiusmod tempor incididunt ut </p>
    ...
    <!--Download apps section start-->
                    ...
                    <div class="download-app-inner">
                        ...
                        <div class="col-md-5 col-sm-12 col-xs-12">
                            <div class="download-apps-caption-img f-right wow fadeUp" data-wow-duration="1.2s" data-wow-delay="0.2s">
                                <img src="{{ URL::asset('img/common/download-caption.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="awesome-feature-img">
                                <div class="awesome-feature-img-border">
                                    <div class="awesome-feature-img-inner">
                                        <img src="{{ URL::asset('img/awesome/feature.jpg') }}" alt="">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="single-team wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="1.3s">
                            ...
                            <div class="team-desc">
                                <div class="team-member-title">
                                    <h6>
                                        <a href="{{ route('agent-details') }}">Agent's Name</a>
                                    </h6>
                                    <p>Real Estate Agent</p>
                                </div>
                                <div class="team-member-social">
        ...
        <div class="happy-client pt-130 wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="1.3s">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="section-title text-center">
