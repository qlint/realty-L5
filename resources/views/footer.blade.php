                    ...
                    <div class="col-md-12">
                        <div class="brand-list">
                            <div class="single-brand">
                                <a href="#"><img src="{{ URL::asset('img/brand/1.png') }}" alt=""></a>
                            </div>
                            <div class="single-brand">
                                <a href="#"><img src="{{ URL::asset('img/brand/2.png') }}" alt=""></a>
                            </div>
                            <div class="single-brand">
                                <a href="#"><img src="{{ URL::asset('img/brand/3.png') }}" alt=""></a>
                            </div>
                            <div class="single-brand">
                                <a href="#"><img src="{{ URL::asset('img/brand/4.png') }}" alt=""></a>
                            </div>
                            <div class="single-brand">
                                <a href="#"><img src="{{ URL::asset('img/brand/5.png') }}" alt=""></a>
                            </div>
                            <div class="single-brand">
                                <a href="#"><img src="{{ URL::asset('img/brand/1.png') }}" alt=""></a>
                            </div>
                                        ...
                                        <div class="f-contact-details">
                                            <div class="single-contact-list">
                                                <div class="contact-icon">
                                                    <img src="{{ URL::asset('img/icon/c-1.png') }}" alt="">
                                                </div>
                                            ...
                                            <div class="single-contact-list">
                                                <div class="contact-icon">
                                                    <img src="{{ URL::asset('img/icon/c-2.png') }}" alt="">
                                                </div>
                                                <div class="contact-text">
                                            ...
                                            <div class="single-contact-list">
                                                <div class="contact-icon">
                                                    <img src="{{ URL::asset('img/icon/c-3.png') }}" alt="">
                                                </div>
                                                <div class="contact-text">
    ...
    <div class="style-customizer closed">
      ...
      <div class="clearfix content-chooser">
        ...
        <ul class="patternChange main-bg-change clearfix">
          <li class="main-bg-1" data-style="main-bg-1" title="Background 1"> <img src="{{ URL::asset('img/customizer/bodybg/bg-1.jpg') }}" alt=""></li>
          <li class="main-bg-2" data-style="main-bg-2" title="Background 2"> <img src="{{ URL::asset('img/customizer/bodybg/bg-2.jpg') }}" alt=""></li>
          <li class="main-bg-3" data-style="main-bg-3" title="Background 3"> <img src="{{ URL::asset('img/customizer/bodybg/bg-3.jpg') }}" alt=""></li>
          <li class="main-bg-4" data-style="main-bg-4" title="Background 4"> <img src="{{ URL::asset('img/customizer/bodybg/bg-4.jpg') }}" alt=""></li>
          <li class="main-bg-5" data-style="main-bg-5" title="Background 5"> <img src="{{ URL::asset('img/customizer/bodybg/bg-5.jpg') }}" alt=""></li>
          <li class="main-bg-6" data-style="main-bg-6" title="Background 6"> <img src="{{ URL::asset('img/customizer/bodybg/bg-6.jpg') }}" alt=""></li>
          <li class="main-bg-7" data-style="main-bg-7" title="Background 7"> <img src="{{ URL::asset('img/customizer/bodybg/bg-7.jpg') }}" alt=""></li>
          <li class="main-bg-8" data-style="main-bg-8" title="Background 8"> <img src="{{ URL::asset('img/customizer/bodybg/bg-8.jpg') }}" alt=""></li>
          <li class="main-bg-9" data-style="main-bg-9" title="Background 9"> <img src="{{ URL::asset('img/customizer/bodybg/bg-9.jpg') }}" alt=""></li>
          <li class="main-bg-10" data-style="main-bg-10" title="Background 10"> <img src="{{ URL::asset('img/customizer/bodybg/bg-10.jpg') }}" alt=""></li>
          <li class="main-bg-11" data-style="main-bg-11" title="Background 11"> <img src="{{ URL::asset('img/customizer/bodybg/bg-11.jpg') }}" alt=""></li>
          <li class="main-bg-12" data-style="main-bg-12" title="Background 12"> <img src="{{ URL::asset('img/customizer/bodybg/bg-12.jpg') }}" alt=""></li>
        </ul>
        <ul class="resetAll">
