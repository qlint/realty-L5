<?php $__env->startSection('title','Article Left Sidebar'); ?>
<?php $__env->startSection('page-title','Blog'); ?>
<?php $__env->startSection('breadcrumb','Blog Details'); ?>
                                ...
                                <div class="recent-post-inner">
                                    <div class="single-recent-post fix">
                                        <div class="recent-post-thumbnail">
                                            <a href="article.php"><img src="<?php echo e(URL::asset('img/blog/r-1.jpg')); ?>" alt=""></a>
                                        </div>
                                        <div class="recent-post-desc">
                                            <div class="post-title">
                                                <h6><a href="article.php">Latest Design Home</a></h6>
                                            </div>
                                    ...
                                    <div class="single-recent-post fix">
                                        <div class="recent-post-thumbnail">
                                            <a href="article.php"><img src="<?php echo e(URL::asset('img/blog/r-2.jpg')); ?>" alt=""></a>
                                        </div>
                                        <div class="recent-post-desc">
                                            <div class="post-title">
                                                <h6><a href="article.php">Real Estate Expo</a></h6>
                                            </div>
                                            <div class="post-publish">
                                    ...
                                    <div class="single-recent-post fix">
                                        <div class="recent-post-thumbnail">
                                            <a href="article.php"><img src="<?php echo e(URL::asset('img/blog/r-3.jpg')); ?>" alt=""></a>
                                        </div>
                                        <div class="recent-post-desc">
                                            <div class="post-title">
                                                <h6><a href="article.php">Corporate House</a></h6>
                                            </div>
                                            <div class="post-publish">
                                ...
                                <div class="property-buying-guide">
                                    <div class="single-guide">
                                        <div class="guide-icon">
                                            <img src="<?php echo e(URL::asset('img/blog/g-1.png')); ?>" alt="">
                                        </div>
                            ...
                            <aside class="single-side-box discount">
                                <div class="discount-inner">
                                    <div class="discount-img">
                                        <img src="<?php echo e(URL::asset('img/blog/discount.jpg')); ?>" alt="">
                                    </div>
                    ...
                    <div class="col-md-8 col-sm-12 col-xs-12">
                        <article class="blog-details">
                            <div class="blog-thubmnail">
                                <a href="#">
                                    <img src="<?php echo e(URL::asset('img/blog/article.jpg')); ?>" alt="">
                                </a>
                                <div class="blog-post">
                                    <span class="post-day">
                                        20
                            ...
                            <div class="article-comment-box">
                                ...
                                <div class="single-comment-box fix">
                                    <div class="comment-thumbnail">
                                        <img src="<?php echo e(URL::asset('img/blog/comment-1.jpg')); ?>" alt="">
                                    </div>
                                    <div class="comment-desc">
                                        <div class="comment-name">
                                            <h6>Stefen Flemming</h6>
                                        </div>
                                ...
                                <div class="single-comment-box reply-comment fix">
                                    <div class="comment-thumbnail">
                                        <img src="<?php echo e(URL::asset('img/blog/comment-2.jpg')); ?>" alt="">
                                    </div>
                                    <div class="comment-desc">
                                        <div class="comment-name">
                                            <h6>Lora Smith</h6>
                                        ...
                                        <div class="comment-post">
                                            <p>11 hour ago,   15 likes</p>
                                        </div>
                                        <div class="comment-content">
                                            <p>There are some business lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiod tempor inc ididunt ut labore et dolore magna aliqua. Ut enim ad minim </p>
                                        </div>
                                        <div class="reply-button">
                                            <a href="#">Reply</a>
                                        </div>
                                ...
                                <div class="single-comment-box fix">
                                    <div class="comment-thumbnail">
                                        <img src="<?php echo e(URL::asset('img/blog/comment-3.jpg')); ?>" alt="">
                                    </div>
                                    <div class="comment-desc">
                                        <div class="comment-name">
                                            <h6>Thomas Albert</h6>
