<?php $__env->startSection('title','Single Properties'); ?>
<?php $__env->startSection('page-title','Single Properties'); ?>
<?php $__env->startSection('breadcrumb','Single Properties'); ?>
                    ...
                    <div class="col-md-8 col-sm-12 col-xs-12 ">
                        <div class="single-property-details">
                            <div class="property-details-img">
                                <img src="<?php echo e(URL::asset('img/property/single-property.jpg')); ?>" alt="">
                            </div>
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xs-12">
                                        <div class="property-condition">
                                            ...
                                            <div class="property-condition-list">
                                                <ul>
                                                    <li>
                                                        <img src="<?php echo e(URL::asset('img/property/icon-6.png')); ?>" alt="">
                                                        <span>Area 450 sqft</span>
                                                    </li>
                                                    <li>
                                                        <img src="<?php echo e(URL::asset('img/property/icon-7.png')); ?>" alt="">
                                                        <span>Bedroom 5</span>
                                                    </li>
                                                    <li>
                                                        <img src="<?php echo e(URL::asset('img/property/icon-8.png')); ?>" alt="">
                                                        <span>Bedroom 5</span>
                                                    </li>
                                                    <li>
                                                        <img src="<?php echo e(URL::asset('img/property/icon-9.png')); ?>" alt="">
                                                        <span>Garage 2</span>
                                                    </li>
                                                    <li>
                                                        <img src="<?php echo e(URL::asset('img/property/icon-10.png')); ?>" alt="">
                                                ...
                                                <div class="property-location">
                                                    <p><img src="<?php echo e(URL::asset('img/property/icon-5.png')); ?>" alt=""> 568 E 1st Ave, Miami</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="planning">
                                <div class="row">
                                    <div class="col-md-5 col-sm-6 col-xs-12">
                                        ...
                                        <div class="plan-map">
                                            <img src="<?php echo e(URL::asset('img/property/plan-map.png')); ?>" alt="">
                                        </div>
                                    </div>
                            ...
                            <div class="feedback">
                                ...
                                <div class="single-feedback mb-35 fix">
                                    <div class="feedback-img">
                                        <img src="<?php echo e(URL::asset('img/feedback/1.png')); ?>" alt="">
                                    </div>
                                ...
                                <div class="single-feedback mb-35 fix">
                                    <div class="feedback-img">
                                        <img src="<?php echo e(URL::asset('img/feedback/2.png')); ?>" alt="">
                                    </div>
                                    <div class="feedback-desc">
                                        <div class="feedback-title">
                                            <h6>Albert Smith</h6>
                                ...
                                <div class="single-feedback fix">
                                    <div class="feedback-img">
                                        <img src="<?php echo e(URL::asset('img/feedback/3.png')); ?>" alt="">
                                    </div>
                                    <div class="feedback-desc">
                                        <div class="feedback-title">
                                            <h6>Albert Smith</h6>
                        ...
                        <div class="sidebar right-side">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="single-property">
                                                <div class="property-img">
                                                    <a href="<?php echo e(route('single-properties')); ?>">
                                                        <img src="<?php echo e(URL::asset('img/property/7.jpg')); ?>" alt="">
                                                    </a>
                                                </div>
                                                <div class="property-desc text-center">
                                                    <div class="property-desc-top">
                                                        <h6><a href="<?php echo e(route('single-properties')); ?>">Concept's Name</a></h6>
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="single-property">
                                                <div class="property-img">
                                                    <a href="<?php echo e(route('single-properties')); ?>">
                                                        <img src="<?php echo e(URL::asset('img/property/11.jpg')); ?>" alt="">
                                                    </a>
                                                </div>
                                                <div class="property-desc text-center">
                                                    <div class="property-desc-top">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                            <div class="single-agent">
                                                <div class="agent-img">
                                                    <a href="<?php echo e(route('agent-details')); ?>">
                                                        <img src="<?php echo e(URL::asset('img/team/1.jpg')); ?>" alt="">
                                                    </a>
                                                </div>
                                                <div class="agent-title">
                                                    <h6><a href="<?php echo e(route('agent-details')); ?>">Agent's Name</a></h6>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                            <div class="single-agent">
                                                <div class="agent-img">
                                                    <a href="<?php echo e(route('agent-details')); ?>">
                                                        <img src="<?php echo e(URL::asset('img/team/5.jpg')); ?>" alt="">
                                                    </a>
                                                </div>
                                                <div class="agent-title">
                                                   <h6><a href="<?php echo e(route('agent-details')); ?>">Agent's Name</a></h6>
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                            <div class="single-agent">
                                                <div class="agent-img">
                                                    <a href="<?php echo e(route('agent-details')); ?>">
                                                        <img src="<?php echo e(URL::asset('img/team/6.jpg')); ?>" alt="">
                                                    </a>
                                                </div>
                                                <div class="agent-title">
                                                    <h6><a href="<?php echo e(route('agent-details')); ?>">Agent's Name</a></h6>
                            ...
                            <aside class="single-side-box video">
                                ...
                                <div class="video-sidebar">
                                    <div class="video-img">
                                        <img src="<?php echo e(URL::asset('img/common/video.jpg')); ?>" alt="">
                                    </div>
