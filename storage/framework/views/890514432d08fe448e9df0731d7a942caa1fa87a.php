...
<?php $__env->startSection('page-title','Agent'); ?>
<?php $__env->startSection('breadcrumb','Agent'); ?>
<?php $__env->startSection('content'); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 col-sm-12 col-xs-12">
                        <div class="welcome-haven-img">
                            <img src="<?php echo e(URL::asset('img/welcome/6.png')); ?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!--Team area start-->
        <div class="team-area bg-1 agent-page">
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="single-team fadeInUp wow" data-wow-delay="0.3s">
                            <div class="team-img">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="single-team fadeInUp wow" data-wow-delay="0.4s">
                            <div class="team-img">
                                <a href="agent-details.php">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="single-team fadeInUp wow" data-wow-delay="0.5s">
                            <div class="team-img">
                                <a href="agent-details.php">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="single-team fadeInUp wow" data-wow-delay="0.4s">
                            <div class="team-img">
                                <a href="agent-details.php">
                                    <img src="<?php echo e(URL::asset('img/team/7.jpg')); ?>" alt="">
                                </a>
                            </div>
                            <div class="team-desc">
                                <div class="team-member-title">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="single-team fadeInUp wow" data-wow-delay="0.5s">
                            <div class="team-img">
                                <a href="agent-details.php">
                                    <img src="<?php echo e(URL::asset('img/team/8.jpg')); ?>" alt="">
                                </a>
                            </div>
                            <div class="team-desc">
                                <div class="team-member-title">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="single-team fadeInUp wow" data-wow-delay="0.3s">
                            <div class="team-img">
                                <a href="agent-details.php">
                                    <img src="<?php echo e(URL::asset('img/team/9.jpg')); ?>" alt="">
                                </a>
                            </div>
                            <div class="team-desc">
                                <div class="team-member-title">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="single-team fadeInUp wow" data-wow-delay="0.4s">
                            <div class="team-img">
                                <a href="agent-details.php">
                                    <img src="<?php echo e(URL::asset('img/team/10.jpg')); ?>" alt="">
                                </a>
                            </div>
                            <div class="team-desc">
                                <div class="team-member-title">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="single-team fadeInUp wow" data-wow-delay="0.5s">
                            <div class="team-img">
                                <a href="agent-details.php">
                                    <img src="<?php echo e(URL::asset('img/team/11.jpg')); ?>" alt="">
                                </a>
                            </div>
                            <div class="team-desc">
                                <div class="team-member-title">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="single-team fadeInUp wow" data-wow-delay="0.3s">
                            <div class="team-img">
                                <a href="agent-details.php"><img src="<?php echo e(URL::asset('img/team/12.jpg')); ?>" alt=""></a>
                            </div>
                            <div class="team-desc">
                                <div class="team-member-title">
                                    <h6><a href="agent-details.php">Agent's Name</a></h6>
