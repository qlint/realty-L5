        ...
        <div class="slider-area">
	        <div class="slider-container overlay home-2" >
	            ...
	            <div id="mainSlider" class="nivoSlider slider-image">
	                <img src="<?php echo e(URL::asset('img/slider/2.jpg')); ?>" alt="" title="#htmlcaption1"/>
	                <img src="<?php echo e(URL::asset('img/slider/1.jpg')); ?>" alt="" title="#htmlcaption2"/>
	                <img src="<?php echo e(URL::asset('img/slider/2.jpg')); ?>" alt="" title="#htmlcaption3"/>
	            </div>
	            <!-- Slider Caption 1 -->
	                                    ...
	                                    <div class="slide1-text">
	                                        <div class="middle-text">
	                                            ...
	                                            <div class="title-2 wow fadeUp" data-wow-duration="1.9s" data-wow-delay="0.1s">
	                                                <h1><span>SIDAI NAIVASHA</span> SOLVES YOUR <br> PROBLEMS</h1>
	                                            </div>	
	                                            <div class="desc wow fadeUp" data-wow-duration="1.2s" data-wow-delay="0.2s">
	                                                <p>Lorem consectetur adipiscing elit, sed do eiusmod tempor dolor sit amet<br> contetur  adipiscing elit, sed do eiusmod tempor incididunt </p>
	                                            </div>
	                                ...
	                                <div class="col-md-12 col-sm-12 col-xs-12">
	                                    <div class="slide1-text">
	                                        <div class="middle-text">
	                                            ...
	                                            <div class="title-2 wow fadeUp" data-wow-duration="1.9s" data-wow-delay="0.1s">
	                                                <h1><span>SIDAI NAIVASHA</span> SOLVE YOUR <br> PROBLEMS</h1>
	                                            </div>	
	                                            <div class="desc wow fadeUp" data-wow-duration="1.2s" data-wow-delay="0.2s">
	                                                <p>Lorem consectetur adipiscing elit, sed do eiusmod tempor dolor sit amet<br> contetur  adipiscing elit, sed do eiusmod tempor incididunt </p>
	                                            </div>
                    ...
                    <div class="find-home-box postion">
                        <div class="find-home-box-inner">
	                        <div class="find-home-title">
	                            <h3><span>FIND YOUR</span> DREAM PROPERTY</h3>
	                        </div>
                            <form action="#">
                                            ...
                                            <div class="find-home-item custom-select ">                  
                                                <select class="selectpicker" title="Location" data-hide-disabled="true" data-live-search="true">
                                                    ...
                                                    <optgroup label="Naivasha">
                                                        ...
                                                        <option>Kiambogo</option>
                                                        <option>Karunga</option>
                                                        <option>Hell's Gate</option>
                                                        <option>Longonot</option>
                                                        <option>Naivasha East</option>
